...
public sealed class RevertTripItemHandler(ITripRepository repository)
    : IRequestHandler<RevertTripItemHandler.Command, Result>
{
    ...
    public async Task<Result> Handle(Command request, CancellationToken cancellationToken)
    {
        ...
        TripItem item = trip.RevertItem(request.ItemId);
